...
$jscomp.polyfill(
    ...
    function (f) {
        ...
        h.prototype.settle_ = function (e, l) {
            if (0 != this.state_)
                throw Error('Cannot settle(' + e + ', ' + l + '): Promise already settled in state' + this.state_);
            this.state_ = e;
            this.result_ = l;
...
var DracoDecoderModule = (function () {
    ...
    return function (m) {
        ...
        function ma(k) {
            ...
            if (!(0 < aa)) {
                if (a.preRun)
                    for ('function' == typeof a.preRun && (a.preRun = [a.preRun]); a.preRun.length; ) Fa.unshift(a.preRun.shift());
                S(Fa);
                0 < aa ||
                    (a.setStatus
                        ? (a.setStatus('Running...'),
            ...
            Ka = {
                ...
                emscripten_resize_heap: function (a) {
                    ...
                    for (var c = Math.max(T.length, 16777216); c < a; )
                        c = 536870912 >= c ? e(2 * c, 65536) : Math.min(e((3 * c + 2147483648) / 4, 65536), 2147418112);
                    a: {
                        try {
        ...
        var hb = (a.___wasm_call_ctors = function () {
            ...
            Va = (a._emscripten_bind_AttributeQuantizationTransform_AttributeQuantizationTransform_0 = function () {
